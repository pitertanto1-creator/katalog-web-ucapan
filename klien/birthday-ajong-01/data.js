window.BIRTHDAY_DATA = {
  ...
  musicMessage: [
    { text: "Hari ini spesial banget.", pink: true },
    {
      text:
        "Bukan cuma karena ulang tahun,<br>tapi karena kamu pantas dirayain."
    },
    {
      text:
        "Semoga hal-hal baik makin sering datang,<br>senyum kamu makin banyak,<br>dan capeknya pelan-pelan diganti bahagia."
    },
    { text: "Enjoy your day yaa 💖", pink: true }
  ],
